...
public partial class RslBisBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, IRslBisVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitValidatepredicate([NotNull] RslBisParser.ValidatepredicateContext context) { return VisitChildren(context); }
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitDnotion([NotNull] RslBisParser.DnotionContext context) { return VisitChildren(context); }
	/// <summary>
